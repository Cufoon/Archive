...
interface OneProvince extends OneCity {
  children: OneCity[];
}

type ProvinceList = OneProvince[];

export const cityListOption: ProvinceList = [
  ...
  { value: 310000, label: '上海市', children: [{ value: 110200, label: '上海市' }] },
  {
    value: 320000,
    label: '江苏省',
    children: [
  ...
  },
  {
    ...
    children: [
      ...
      { value: 469000, label: '省直辖县级行政单位' }
    ]
  },
  { value: 500000, label: '重庆市', children: [{ value: 120200, label: '重庆市' }] },
  {
    value: 510000,
    label: '四川省',
    children: [
  ...
  { value: 810000, label: '香港特别行政区', children: [{ value: 810000, label: '香港特别行政区' }] },
