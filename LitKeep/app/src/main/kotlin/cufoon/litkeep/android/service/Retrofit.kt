...
val retrofitJSON: Retrofit = Retrofit.Builder().baseUrl("https://android.studio.is.shit/")
    .addConverterFactory(moshiConverter).build()

val retrofitWithTokenJSON: Retrofit = Retrofit.Builder().baseUrl("https://android.studio.is.shit/")
    .addConverterFactory(moshiConverter).client(okHttpClient).build()
